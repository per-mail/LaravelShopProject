    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Редактирование списка пользователей</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
...
{{--                                name='name': name-берём из базы --}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group w-50">
{{--               эта строка для того, чтобы обновлять роль пользователя и не выходила ошибка, что такой email уже есть в базе--}}
